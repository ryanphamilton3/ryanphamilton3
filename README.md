...
<head>
  ...
  <title>
    Ryan Hamilton | A Data Analyst and programmer in West Lawn, PA.
  </title>
  ...
  <section class="contact" id="contact">
    <div class="row">
      ...
      <div class="contact__info">
        <p>
          Do you have data analysis that needs to be done on large amounts of Excel, SQL, CSV, or even JSON files? 
          Click the link below to get in contact!
        </p>
        <!-- Replace the email with yours -->
        <a href="mailto:ryanphamilton3@gmail.com" class="btn">ryanphamilton3@gmail.com</a>
      </div>
    </div>
  </section>
